$(function() {
    ...
    var gameMode = '', word = '', jumbledWord = '', wordHolder = '', difficulty = '', userGuess = '', noVowelsWord = '', lettersMissingWord = '';
	...
	var gameTitle = function(title) {
		$('h1').text(title);
	}
	
	// Choose the game to play
	$('#gameWordJumble, #gameMissingVowels, #gameMissingLetters').click(function() {
		//var gameMode;
		//var $gameTitle = $('#gameTitle');
		
		$('#gameMenu').hide();
		
		if($(this).attr('id') === 'gameWordJumble') {
			//console.log('Word Jumble was clicked');
			gameMode = 'Word Jumble';
			//gameTitle('Word Jumble');
		} else if($(this).attr('id') === 'gameMissingVowels') {
			//console.log('Missing Vowels was clicked');
			gameMode = 'Missing Vowels';
			//gameTitle('Missing Vowels');
		} else if($(this).attr('id') === 'gameMissingLetters') {
			//console.log('Missing Letters was clicked');
	...
	$('#startMenu .back_button').click(function() {
		$('#startMenu').hide();
		console.log('clicked');
    ...
    $('#instructions_button').click(function() {
		...
		switch(gameMode) {
			case 'Word Jumble':
				$('#wordJumbleInstructions').show();
				break;
			case 'Missing Vowels':
				$('#missingVowelsInstructions').show();
				break;
			case 'Missing Letters':
				$('#missingLettersInstructions').show();
				break;
		}
    ...
    $('#instructions .back_button, #difficulty_content .back_button').click(function() {
	...
	function gameToPlay() {
		switch(gameMode) {
			...
			case 'Missing Vowels':
				removeVowels();
				$('#jumbled_word').text(noVowelsWord);
				break;

			case 'Missing Letters':
				removeLetters();
				$('#jumbled_word').text(lettersMissingWord);
				break;
		}
	}
	...
	// JUMBLE UP LETTERS FROM THE RANDOM CHOSEN WORD
	...
	// REMOVE THE VOWELS FROM THE RANDOM CHOSEN WORD
	function removeVowels() {
		if(level < 5) {
			...
			noVowelsWord = word;
		} else if(level > 5 && difficulty != 'easy') {
			var vowelSet1 = /a|e|i|o|u/g;
			var vowelSet2 = /a|e|i|o|u/g;
			var vowelSet3 = /a|e|i|o|u/g;
			//var wordHolder = word;
			word = word.replace(vowelSet1, "_");
			word = word.replace(vowelSet2, "_");
			word = word.replace(vowelSet3, "_");
			noVowelsWord = word;
		}
	...
	// REMOVE RANDOM LETTERS FROM THE RANDOM CHOSEN WORD
		...
		switch(difficulty) {
			...
			case 'hard':
				do {
					var firstLetter = Math.floor(Math.random() * word.length);
					var secondLetter = Math.floor(Math.random() * word.length);
					var thirdLetter = Math.floor(Math.random() * word.length);
				} while(firstLetter === secondLetter || firstLetter === thirdLetter || thirdLetter === secondLetter);
				word = word.replace(word[firstLetter], "_");
				word = word.replace(word[secondLetter], "_");
				word = word.replace(word[thirdLetter], "_");
				break;
			case 'vary hard':
				do {
					var firstLetter = Math.floor(Math.random() * word.length);
					var secondLeter = Math.floor(Math.random() * word.length);
					var thirdLetter = Math.floor(Math.random() * word.length);
					var fourthLetter = Math.floor(Math.random() * word.length);
				} while(firstLetter === secondLetter);
				word = word.replace(word[firstLetter], "_");
				word = word.replace(word[secondLetter], "_");
				word = word.replace(word[thirdLetter], "_");
				word = word.replace(word[fourthLetter], "_");
				break;
		}
